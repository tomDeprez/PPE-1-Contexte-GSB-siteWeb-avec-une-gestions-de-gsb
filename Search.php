...
$stmt = $dbh->prepare("SELECT DISTINCT nom FROM patient WHERE nom LIKE :nom OR prenom LIKE :prenom LIMIT 10");
...
foreach ($result as $key => $value) {
    ...
    <div class='image-container'><img src='https://placeimg.com/40/40/face' /></div>
    <div class='text'><span class='name'>".$result[$key]['nom']." </span>added a new appointment to your calendar.<span class='time-ago'>2 hours ago</span></div>
    </div>";
}
echo $get;
